...
<script type="text/javascript">
	function ApproveDict(flags) {
		...
		$.post("${pageContext.request.contextPath}/urlInfo/agencyapprove", {
			taskId : taskId,
...
<div class="modal-content">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<input type="hidden" id="dictId" value="${tmDictionary.id}" /> <input type="text"
						...
						value="${tmDictionary.dictValue}" disabled="disabled"/>
				</div>
			</div>
			<div class="row" style="margin-top: 10px;">
				...
				<div class="col-md-4">
					<input type="text" id="dictName" style="width: 200px;"
						value="${tmDictionary.dictName}" disabled="disabled"/>
				</div>
			</div>
			<div class="row" style="margin-top: 10px;">
				...
				<div class="col-md-4">
					<input type="text" id="dictDesc" style="width: 200px;"
						value="${tmDictionary.dictDesc}" disabled="disabled"/>
				</div>
			</div>
			<div class="row" style="margin-top: 10px;">
				...
				<div class="col-md-4">
					<input type="text" id="dictType" style="width: 200px;"
						value="${tmDictionary.dictType}" disabled="disabled"/>
				</div>
			</div>
			<div class="row" style="margin-top: 10px;">
				<label for="dictType" class="col-md-2 col-md-offset-1 control-label">审批意见</label>
				<div class="col-md-4">
	...
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-primary"
			onclick="ApproveDict(true)">同意</button>
		<button type="button" class="btn btn-primary"
			onclick="ApproveDict(false)">退回</button>
	</div>
</div>